...
badd +0 .config/nvim/lua/MistbornOne/plugins/lsp/lspconfig.lua
argglobal
%argdel
edit .config/nvim/lua/MistbornOne/plugins/lsp/lspconfig.lua
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 35 + 58) / 117)
exe 'vert 2resize ' . ((&columns * 81 + 58) / 117)
argglobal
enew
file NvimTree_1
setlocal keymap=
...
setlocal statusline=%<%#lualine_c_inactive#\ NvimTree_1\ [-]\ %#lualine_c_inactive#%=%#lualine_c_inactive#\ \ \ 9:1\ \ 
...
setlocal statuscolumn=
setlocal statusline=%#lualine_a_command#\ COMMAND\ %#lualine_transitional_lualine_a_command_to_lualine_b_command#î‚°%#lualine_b_command#\ î‚ \ main\ î‚±%#lualine_b_diff_added_command#\ +15\ %#lualine_b_diff_modified_command#~134\ %#lualine_b_command#î‚±%#lualine_b_diagnostics_warn_command#\ ó°€ª\ 13\ %#lualine_b_diagnostics_hint_command#ó°Œ¶\ 7\ %<%#lualine_c_command#\ lspconfig.lua\ %#lualine_c_command#%=%#lualine_c_command#\ utf-8\ î‚³%#lualine_c_command#\ îœ’\ î‚³%#lualine_x_filetype_DevIconLua_command#\ î˜ \ %#lualine_c_command#lua\ %#lualine_b_command#\ 29%%\ %#lualine_transitional_lualine_a_command_to_lualine_b_command#î‚²%#lualine_a_command#\ \ 44:23\ 
